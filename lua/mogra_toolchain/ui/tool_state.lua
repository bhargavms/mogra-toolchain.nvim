...
function ToolState.new(tool)
  ...
  self.is_log_expanded = true -- Start expanded by default
  self.tailed_output = ""
...
---Toggle log expansion state
function ToolState:toggle_log()
...
function ToolState:install(mutate_state)
  -- Reset log state (keep is_log_expanded as user preference)
  self.tailed_output = ""
  self.short_tailed_output = nil
